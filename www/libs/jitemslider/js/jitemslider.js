    ...
    if ('undefined' === typeof window.itemSlider) {
        ...
        window.itemSlider = function (options) {
            ...
            function initialPaint() {
                ...
                if (true === d.infinite) {
                    ...
                    for (i = the_offset; i < nbElsPerPage; i++) {
                        paintItem(mod(i, length), "main");
                    }

                    // paint extra item
                    paintItem(mod(i++, length), "extra");
                    ...
                    paintItem(mod(start--, length), "extra" + s, false);
                    ...
                    paintItem(itemToCopyIndex, 'extra invisible', false);
                    for (i = 0; i < nbElsPerPage; i++) {
                        paintItem(itemToCopyIndex, 'prev invisible', false);
                    }
                }
                alignByFirstItem();
            }
            ...
            function renameItems() {
                ...
                var c = 0;
                var d = 0;
                jSliderContent.find('> .item').each(function () {
                    $(this).removeClass("prev next extra main");
                    if (c < nbElsPerPage) {
                        $(this).addClass('prev');
                    }
            ...
            function cutLeft() {
                jSliderContent.find('> .prev').remove();
                offset += getPageWidth();
                repositionSlider(offset);
            }

            function cutRight() {
                jSliderContent.find('> .next').remove();
            }

            function hasPrevious() {
                return (jSliderContent.find('> .prev').length > 0);
            }
            ...
            function getFirstMainItem() {
                 ...
                 */
                return jSliderContent.find('> .main').not('.invisible').first();
            }

            function getLastMainItem() {
                return jSliderContent.find('> .main').last();
            }

            function getLastItemOffset() {
                return jSliderContent.find('> .item').last().data('id');
            }

            function getFirstItemOffset() {
                return jSliderContent.find('> .item').first().data('id');
            }
            ...
            function paintPrevSlice(startOffset) {
                ...
                if (true === d.infinite) {
                    for (i = startOffset; i > end; i--) {
                        paintItem(mod(i, getItemsLength()), "prev", false);
                    }
                }
                else {
                    for (i = startOffset; i > end; i--) {
                        if (i >= 0) {
                            paintItem(i, "prev", false);
                        }
                        else {
                            paintItem(0, "prev invisible", false);
                        }
                    }
                }
            }
                ...
                if (0 !== delta) {
                    ...
                    if (delta > 0) {
                        ...
                        if (true === _hasPrevious) {
                            ...
                            var hasInvisible = jSliderContent.find('> .item').first().hasClass('invisible');
                            if (true === hasInvisible && false === d.infinite) {
                                ...
                                if (false === d.infinite) {
                                    ...
                                    for (i = startOffset; i > end; i--) {
                                        paintItem(mod(i, length), "prev", false);
                                    }
                                }
                            }
                        }
                    ...
                    // the number of items has been diminished
                         ...
                         */
                        if (false === d.infinite) {
                            var nbMain = jSliderContent.find('> .main').length;
                            if (nbMain <= n) {
                                removeNext = false;
                            }
                        }
                        ...
                        if (true === removeNext) {
                            $(jSliderContent.find('> .item').get().reverse()).each(function () {
                                if (n > 0) {
                                    $(this).remove();
                                    n--;
                                }
            ...
            var jSliderContent = jSlider.find('.slider_content');
            var isLocked = false;
            ...
            this.moveLeft = function () {
                if (false === isLocked) {
                    ...
                    if (true === d.infinite) {
                        jSliderContent.find('> .invisible').removeClass('invisible');
                    }
